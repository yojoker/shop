...
<head>
	...
	<title>京西商城</title>
	<link rel="shortcut icon" href="/tpshop/Public/Home/images/favicon.ico" />
...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
				<!-- 判断是否登录 -->
				<?php if(session('user_login')==1): ?><li>您好， <?php echo session('nickname');?>  欢迎回到京西！[<a href="<?php echo U('User/index');?>">会员中心</a>] [<a href="<?php echo U('User/logout');?>">退出</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w1210 bc mt15">
		...
		<div style="clear:both;"></div>
		<?php $not_index=(CONTROLLER_NAME!='Index' || ACTION_NAME!='index');?>
		<!-- 导航条部分 start -->
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<div class="category fl <?php echo ($not_index?'cat1':''); ?>"> <!-- 非首页，需要添加cat1类 -->
				<div class="cat_hd <?php echo ($not_index?'off':''); ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
					<h2>全部商品分类</h2>
					<em></em>
				</div>
				<div class="cat_bd <?php echo ($not_index?'none':''); ?>">	
				<?php if(is_array($cateList)): foreach($cateList as $key=>$one): if($one['cate_pid']==0): ?><div class="cat item1">
						<h3><a href="<?php echo U('Goods/index',array('cid'=>$one['cate_id']));?>"><?php echo ($one['cate_name']); ?></a> <b></b></h3>
						<div class="cat_detail <?php echo ($not_index?'none':''); ?>">
						<?php if(is_array($cateList)): foreach($cateList as $key=>$two): if($two['cate_pid']==$one['cate_id']): ?><dl class="dl_1st">
								<dt><a href="<?php echo U('Goods/index',array('cid'=>$two['cate_id']));?>"><?php echo ($two['cate_name']); ?></a></dt>
								<dd>
								<?php if(is_array($cateList)): foreach($cateList as $key=>$three): if($three['cate_pid']==$two['cate_id']): ?><a href="<?php echo U('Goods/index',array('cid'=>$three['cate_id']));?>"><?php echo ($three['cate_name']); ?></a><?php endif; endforeach; endif; ?>
								</dd>
...
<link rel="stylesheet" href="/tpshop/Public/Home/style/index.css" type="text/css">
<link rel="shortcut icon" href="/tpshop/Public/Home/images/favicon.ico" />
<script type="text/javascript" src="/tpshop/Public/Home/js/index.js"></script>
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="/tpshop/Public/Home/images/ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="/tpshop/Public/Home/images/holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="/tpshop/Public/Home/images/scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="/tpshop/Public/Home/images/lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="/tpshop/Public/Home/images/sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="/tpshop/Public/Home/images/taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="/tpshop/Public/Home/images/wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/crazy1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/crazy2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/crazy3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/crazy4.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/crazy5.jpg" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/recommend3.jpg" alt="" /></a></dt>
				...
				<div class="new none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/new1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/new2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/new3.jpg" alt="" /></a></dt>
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/guess1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/guess2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/guess3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="/tpshop/Public/Home/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="/tpshop/Public/Home/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="/tpshop/Public/Home/images/notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/hpG4.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="/tpshop/Public/Home/images/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="/tpshop/Public/Home/images/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="/tpshop/Public/Home/images/canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
