...
<body>
	...
	<link rel="stylesheet" href="/tpshop/Public/Home/style/list.css" type="text/css">
	<script type="text/javascript" src="/tpshop/Public/Home/js/list.js"></script>
	...
	<div class="list w1210 bc mt10">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
				<?php if(is_array($goodsList)): foreach($goodsList as $key=>$goods): ?><li>
						<dl>
							<dt><a href="<?php echo U('Goods/detail',array('id'=>$goods['goods_id']));?>"><img title="<?php echo ($goods['goods_name']); ?>" src="/Uploads/<?php echo ($goods['goods_logo_thumb']); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('Goods/detail',array('id'=>$goods['goods_id']));?>"><?php echo (substr($goods['goods_name'] ,0,10)); ?></a></dt>
							<dd><strong>￥<?php echo ($goods['goods_price']); ?></strong></dt>
							<dd><a href="<?php echo U('Goods/detail',array('id'=>$goods['goods_id']));?>"><em>已有10人评价</em></a></dt>
						</dl>
