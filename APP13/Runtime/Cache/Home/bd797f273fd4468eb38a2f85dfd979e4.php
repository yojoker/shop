...
<body>
	...
	<!--引入jqzoom css -->
	<script type="text/javascript" src="/tpshop/Public/Home/js/goods.js"></script>
	<script type="text/javascript" src="/tpshop/Public/Home/js/jqzoom-core.js"></script>
	<link rel="stylesheet" href="/tpshop/Public/Home/style/goods.css" type="text/css">
	<link rel="stylesheet" href="/tpshop/Public/Home/style/common.css" type="text/css">
	<link rel="stylesheet" href="/tpshop/Public/Home/style/jqzoom.css" type="text/css">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/tpshop/Public/Home/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/Uploads/<?php echo ($picsList[0]['pics_bg']); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/Uploads/<?php echo ($picsList[0]['pics_md']); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
							<?php if(is_array($picsList)): foreach($picsList as $i=>$pics): ?><li class="<?php echo ($i==0?'cur':''); ?>">
									<a class="<?php echo ($i==0?'zoomThumbActive':''); ?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/Uploads/<?php echo ($pics['pics_md']); ?>',largeimage: '/Uploads/<?php echo ($pics['pics_bg']); ?>'}"><img src="/Uploads/<?php echo ($pics['pics_sm']); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo ($goodsInfo['sale_time']); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>

						<?php if(is_array($radioAttrList)): foreach($radioAttrList as $key=>$radioAttr): ?><li class="product">
								<dl>
									<dt><?php echo ($key); ?>：</dt>
									<dd>
									<?php if(is_array($radioAttr)): foreach($radioAttr as $k=>$attr): ?><a class="<?php echo ($k==0?'selected':''); ?>" data-price="<?php echo ($attr['attr_price']); ?>" href="javascript:;"><?php echo ($attr['attr_price']); ?> <input type="radio" name="color" value="<?php echo ($attr['attr_value']); ?>" <?php echo ($k==0?'checked':''); ?> /></a>
						...
						<script>
							var shop_price=$('.shop_price strong');
							var price =shop_price.html()-0;
							$('.product a').on('click',function(){
								var _this=$(this); //保存当前被点击的a标签
								var p=0; // 初始化溢价
								//获取其他选中属性的价格
								$('.product a.selected').each(function(key,value){
									if($(value).parent()[0]!==_this.parent()[0]){

										p+=$(value).data('price')-0;
									}
								});
								//当前属性对应的价格
								p+=$(this).data('price')-0;
								var new_price=price+p;
								new_price=new_price.toFixed(2);
								shop_price.html(new_price);
							});
						...
						#cartBox{
							...
							/*购物车弹出框*/
							.orange{color: #CC0000;}
							a.bt_orange:link,a.bt_orange:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/tpshop/Public/Home/images/chakanBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer; display:block; _display:inline; float:left; margin-left:60px;}
							a.bt_blue:link,a.bt_blue:visited{color:#FFFFFF;width:107px; height:27px; line-height:27px;background:url(/tpshop/Public/Home/images/tiaoxuannBtn.jpg) no-repeat; text-align:center; font-weight:bold;cursor:pointer;display:block;_display:inline; float:right; margin-right:60px;}
							...
							.buy_blank h4{ border-bottom:2px solid #D0D0D0; font-weight:normal; height:30px; line-height:30px;background:url(/tpshop/Public/Home/images/buyicon.jpg) no-repeat 10px center; text-indent:28px; margin-bottom:10px; padding-left:20px;}
				        ...
				        <div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
				            <h4>
				                <span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="/tpshop/Public/Home/images/close.jpg" title="点击关闭"/></a></span>
				                该商品已成功添加到购物车
				            </h4>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
							<?php if(is_array($attrList)): foreach($attrList as $key=>$attr): ?><li><span><?php echo ($attr['attr_name']); ?>:</span><?php echo ($attr['attr_value']); ?></li><?php endforeach; endif; ?>	
							</ul>
						</div>
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/tpshop/Public/Home/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
