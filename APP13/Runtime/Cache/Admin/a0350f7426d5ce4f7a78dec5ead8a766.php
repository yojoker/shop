...
<head>
    ...
    <style>
    .loginbox{ background-image: url('/Public/Admin/images/findpwd.png'); }
...
<body style="background-color:#1c77ac; background-image:url(/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    ...
    <form action="<?php echo U('Index/findpwd');?>" method="post">
        <div class="loginbody">
            ...
            <div class="loginbox">
                <ul>
                    ...
                    <li>
                        <input name="email" type="email" class="loginpwd" placeholder="邮箱地址" />
                    </li>
                    <li>
                        <input name="" type="submit" class="loginbtn" value="发送邮件" />
                    </li>
                </ul>
            </div>
        </div>
