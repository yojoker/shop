...
<body>
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="<?php echo U('Goods/index');?>}">表单</a></li>
        </ul>
    </div>
    <div class="formbody">
        <div class="formtitle">
        ...
        <form action="<?php echo U('Goods/edit');?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="goods_id" value="<?php echo ($goodsInfo['goods_id']); ?>"></input>
            <input type="hidden" name="old_logo_src" value="<?php echo ($goodsInfo['goods_logo_src']); ?>"></input>
            <input type="hidden" name="old_logo_thumb" value="<?php echo ($goodsInfo['goods_logo_thumb']); ?>"></input>
                <li>
                    <label>商品名称</label>
                    <input name="goods_name" value="<?php echo ($goodsInfo['goods_name']); ?>" placeholder="请输入商品名称" type="text" class="dfinput" /><i>名称不能超过30个字符</i></li>
                <li>
                    <label>商品价格</label>
                    <input name="goods_price" value="<?php echo ($goodsInfo['goods_price']); ?>" placeholder="请输入商品价格" type="text" class="dfinput" /><i></i></li>
                <li>
                    <label>市场价格</label>
                    <input name="market_price" value="<?php echo ($goodsInfo['market_price']); ?>"  placeholder="请输入市场价格" type="text" class="dfinput" /><i></i>
                </li>
                <li>
                    <label>logo图片</label>
               
                    <input name="goods_logo_src" id="f" type="file" onchange="change()" />
                   <img id="preview"  src="/Uploads/<?php echo ($goodsInfo['goods_logo_src']); ?>" /> <!-- 图片预览在这里展示 -->
                ...
                <li>
                    <label>虚拟销量</label>
                    <input name="sale_number" value="<?php echo ($goodsInfo['sale_number']); ?>"  placeholder="请输入商品数量" type="text" class="dfinput" />
                </li>
                <li>
                    <label>商品分类</label>
                ...
                <li>
                    <label>商品重量</label>
                    <input name="goods_weight" value="<?php echo ($goodsInfo['goods_weight']); ?>"  placeholder="请输入商品重量" type="text" class="dfinput"></input>
                </li> 
                <li>
                    <label>上架时间</label>
                    <input name="sale_time" value="<?php echo (date('Y-m-d H:i:s',$goodsInfo['sale_time'])); ?>"  placeholder="点击输入时间" id="sale_time" type="text" class="dfinput"></input>
                </li>  

                <li>
                    <label>商品排序</label>
                    <input name="sort" value="<?php echo ($goodsInfo['sort']); ?>"   placeholder="数值越大，越靠后" type="text" class="dfinput"></input>
                </li> 
            </ul>
