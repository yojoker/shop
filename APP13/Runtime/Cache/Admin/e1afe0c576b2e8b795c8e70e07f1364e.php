...
<body>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo U('GoodsAttribute/add');?>" method="post">
            <ul class="forminfo">
                <li>
                    <label>属性名称</label>
                    <input name="attr_name" placeholder="请输入属性名称" type="text" class="dfinput" /><i>名称不能超过30个字</i>
                </li>
                <li>
                    <label>商品类型</label>
                ...
                <li>
                    <label>值录入方式</label>
                    <cite>
                    <input type="radio" name="attr_write" value="0" checked="checked" />手动录入&nbsp;
