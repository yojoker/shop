...
require_once './Plugin/sms/vendor/autoload.php';
...
class Sms{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = C('SMS_KEY'); // AccessKeyId

        $accessKeySecret = C('SMS_Secret'); // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$data,$code='SMS_125026054',$sign='益国益民') {
